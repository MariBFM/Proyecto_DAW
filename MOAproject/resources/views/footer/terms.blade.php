...
@section('content')
  <div class="d-flex flex-column justify-content-between align-items-center h-100">
    ...
    <div id="contenido_home" class="container d-flex flex-column flex-grow-1 w-50 p-3 align-items-center fw-light">
      <h2 class="fw-normal">Terminos y Condiciones de Uso</h2>
      <h3 class="fw-normal">INFORMACIÓN RELEVANTE</h3>
      ...
      <p>Es requisito necesario para la adquisición de los productos que se ofrecen en este sitio, que lea y acepte los siguientes Términos y Condiciones que a continuación se redactan. El uso de nuestros servicios así como la compra de nuestros productos implicará que usted ha leído y aceptado los Términos y Condiciones de Uso en el presente documento. Todas los productos  que son ofrecidos por nuestro sitio web pudieran ser creadas, cobradas, enviadas o presentadas por una página web tercera  y en tal caso estarían sujetas a sus propios Términos y Condiciones. En algunos casos, para adquirir un producto, será necesario el registro por parte del usuario, con ingreso de datos personales fidedignos y definición de una contraseña.
        ...
        El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. MOA.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.
        ...
        <h3 class="fw-normal">LICENCIA</h3>
        <p>MOA Project  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
        </p>

        <h3 class="fw-normal">USO NO AUTORIZADO</h3>
        ...
        <h3 class="fw-normal">COMPROBACIÓN ANTIFRAUDE
        </h3>
        ...
        <h3 class="fw-normal">PRIVACIDAD</h3>
        <p>Este MOA.com garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
        </p>
        ...
        <p>MOA Project reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
    </div>
